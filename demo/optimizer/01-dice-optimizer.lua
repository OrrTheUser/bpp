...
-- Set parameters here
optimized_die = die_2
optimized_rotation = die_2_top_face_is_12
v.optimizer:addOptimizationValues("zVel", -363, -100, 1)
v.optimizer:addOptimizationValues("xVel", 1, 10, 1)

original_rotation = optimized_die.trans:getRotation()

die_2.vel = btVector3(v.optimizer:getOptimizationValue("xVel"),3,0.1 * v.optimizer:getOptimizationValue("zVel"))
...
v:postSim(function(N)
  if(N == 0) then
	...
	print("--")
	print(v.optimizer:getOptimizationValue("xVel"))

...
-- Set parameters here
v.optimizer:addOptimizationValues("zVel", -500, -400, 1)

die_2.vel = btVector3(2,3, 0.1 * v.optimizer:getOptimizationValue("zVel"))

function target_func()  
  face_12_orig_orientation = btVector3(0, 0, -1)
  curr_rot = die_2.trans:getRotation()
  curr_orientation = face_12_orig_orientation:rotate(curr_rot:getAxis(),curr_rot:getAngle())
...
v:postSim(function(N)
  if(N == 0) then
	...
	print("--")
	print(v.optimizer:getOptimizationValue("zVel"))

...
function target_func()  
  ...
  curr_orientation = wanted_face:rotate(curr_rot:getAxis(),curr_rot:getAngle())
  is_right_face_up = 1 - btVector3(0,1,0):dot(curr_orientation)
  velocity = die_1.vel:length()
  height = die_1.pos:getY()
  die_1_target = (200 * is_right_face_up) + (velocity) + height
  
  --die 2
  curr_rot = die_2.trans:getRotation()
  curr_orientation = wanted_face:rotate(curr_rot:getAxis(),curr_rot:getAngle())
  is_right_face_up = 1 - btVector3(0,1,0):dot(curr_orientation)
  velocity = die_2.vel:length()
  height = die_2.pos:getY()
  die_2_target = (200 * is_right_face_up) + (velocity) + height
  
  --die 3
  curr_rot = die_3.trans:getRotation()
  curr_orientation = wanted_face:rotate(curr_rot:getAxis(),curr_rot:getAngle())
  is_right_face_up = 1 - btVector3(0,1,0):dot(curr_orientation)
  velocity = die_3.vel:length()
  height = die_3.pos:getY()
  die_3_target = (200 * is_right_face_up) + (velocity) + height
...
function setcam_on_1()
  ...
  d = -1000
  v.cam.pos  = die_1.pos + btVector3(0,100,0)
  v.cam.look = die_1.pos
end

function setcam_on_2()
  v.cam:setUpVector(btVector3(0,1,0), false)
  v.cam:setHorizontalFieldOfView(0.4)
  d = -1000
  v.cam.pos  = die_2.pos + btVector3(0,100,0)
  v.cam.look = die_2.pos
end

function setcam_on_3()
  v.cam:setUpVector(btVector3(0,1,0), false)
  v.cam:setHorizontalFieldOfView(0.4)
  d = -1000
  v.cam.pos  = die_3.pos + btVector3(0,100,0)
